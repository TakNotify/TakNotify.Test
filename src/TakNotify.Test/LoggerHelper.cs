...
{
    /// <summary>
    /// Helper and extension methods for logger tests
    /// </summary>
    public static class LoggerHelper
    {
        /// <summary>
        /// Verify the invocation of a logger
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="loggerMock">The mock of <see cref="ILogger"/></param>
        ...
        /// <param name="loggerMock">The mock of <see cref="ILogger"/></param>
        /// <param name="level">The log level</param>
        /// <param name="message">The log message (it has to be exact)</param>
        ...
        /// <param name="message">The log message (it has to be exact)</param>
        /// <param name="times">The number of invocations</param>
        /// <param name="failMessage">The message to display when test is failed</param>
        ...
        /// </summary>
        /// <param name="namedFormat">The named format, e.g. {firstName}</param>
        /// <param name="values">The values to be filled into the format string</param>
        /// <returns></returns>
